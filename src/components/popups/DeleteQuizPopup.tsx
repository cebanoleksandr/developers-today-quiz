...
const DeleteQuizPopup: FC<IProps> = (props) => {
  return (
    <Popup
      state={props.state}
    ...
    >
      <div className='w-[500px] bg-white p-7 rounded-xl'>
        ...
        <div className='mb-10'>
          <p className="text-gray-500 font-semibold text-center">Are you sure you want to delete {props.quiz.title}?</p>
        </div>
        ...
        <div className='flex justify-end items-center gap-2'>
          ...
          <button
            ...
            onClick={() => props.onDelete(props.quiz._id)}
          >
